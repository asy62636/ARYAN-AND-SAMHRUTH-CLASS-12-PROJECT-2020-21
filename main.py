...
We wish that your times get better from here on. In order to connect you with people who can advice you on the same, a few names are: Aryan (4204566987), Sam (8431169420), Rohan (3589842012).
...
We hope that you are currently doing okay and are in a slightly stable environment as you read this.
We wish to tell you that you are not alone. There are people that you can talk to. Though it may seem like a massive hurdle at first, we hope we can help you take the first step in overcoming your problems so that you may live upto your full potential.
We wish that your times get better from here on. In order to connect you with people who can advice you on the same, a few names are: Ram H (6932420579), KK Bhaskar (4206956732), Yugandhar G (9886942012).
...
We hope that you are currently doing okay and are in a slightly stable environment as you read this.
We wish to tell you that you are not alone. There are people that you can talk to. Though it may seem like a massive hurdle at first, we hope we can help you take the first step in overcoming your problems so that you may live upto your full potential.
We wish that your times get better from here on. In order to connect you with people who can advice you on the same, a few names are: Kapu Nirmal Joshua (4206954321), Anand Balivada (8008135420), Dhruv Poduval (9876543210).
...
We hope that you are currently doing okay and are in a slightly stable environment as you read this.
We wish to tell you that you are not alone. There are people that you can talk to. Though it may seem like a massive hurdle at first, we hope we can help you take the first step in overcoming your problems so that you may live upto your full potential.
We wish that your times get better from here on. In order to connect you with people who can advice you on the same, a few names are: Sanidhya Dwivedi (6969345698), Arka Pudota (9887694208), Abhinav Chinta (4209873269).
...
We hope that you are currently doing okay and are in a slightly stable environment as you read this.
We wish to tell you that you are not alone. There are people that you can talk to. Though it may seem like a massive hurdle at first, we hope we can help you take the first step in overcoming your problems so that you may live upto your full potential.
We wish that your times get better from here on. In order to connect you with people who can advice you on the same, a few names are: Anirudh S (4209821563), Luv Singhal (9886114532), Vishnu Anand (6954469455).
...
We hope that you are currently doing okay and are in a slightly stable environment as you read this.
We wish to tell you that you are not alone. There are people that you can talk to. Though it may seem like a massive hurdle at first, we hope we can help you take the first step in overcoming your problems so that you may live upto your full potential.
We wish that your times get better from here on. In order to connect you with people who can advice you on the same, a few names are: Vrishab Krishna (8236956420), Yashas Vatsyayan (6987342067), Sujal KS (9886918420).
...
def database_create():
    ...
    cursor.execute('create table domestic_violence(name varchar(30),phone_num integer, email varchar(50), issues varchar(75))')
    cursor.execute('create table animal_abuse(name varchar(30),phone_num integer, email varchar(50), issues varchar(75))')
    cursor.execute('create table addiction(name varchar(30),phone_num integer, email varchar(50), issues varchar(75))')
    cursor.execute('create table financial_aid(name varchar(30),phone_num integer, email varchar(50), issues varchar(75))')
    cursor.execute('create table depression(name varchar(30),phone_num integer, email varchar(50), issues varchar(75))')
    cursor.execute('create table others(name varchar(30),phone_num integer, email varchar(50), issues varchar(75))')
